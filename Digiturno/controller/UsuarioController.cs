...
namespace Digiturno.Controller
{
    ...
    public class UsuarioController
    {
        ...
        public Usuario CrearUsuario(string nombre, string usuario, string contraseña, Rol tipoRol)
        {
        ...
        public bool ActualizarUsuario(int id, string nuevoNombre, string nuevoUsuario, string nuevaContraseña, Rol nuevoRol)
        {
            var usuario = BuscarPorId(id);
            if (usuario != null)
            {
                ...
                Console.WriteLine($"Usuario actualizado: {usuario.nombre}, Rol: {usuario.tipoRol}");
                return true;
            }
            else
            {
