...
namespace Digiturno.Controller
{
    public class TurnoController
    {
        ...
        public List<Turno> ListarTurnos()//Metodo para mostrar los turnos
        {
            ...
            {
                Console.WriteLine($"- Código: {turno.letra}{turno.numero:D3}, Estado: {turno.estado}");
            }
            return turnos;

        }

        //Método para buscar un turno por su código
        ...
        public void FinalizarTurno(string codigo) { 
            ...
            switch (turno.estado) //Verifica el estado del turno
            {
